...
export default function Home() {
  return ( 
    <div className='h-full main_bg text-white overflow-hidden' id='top'>
      ...
      <TopCreator />
      <FAQ />
      <Container className={undefined} children={undefined}>
        <div
          className={
        ...
        >
          ...
          <Reveal delay={200} duration={1000} keyframes={fadeInDownShorter}>
            <Button variant={undefined} isLink={undefined} href={undefined} onClick={undefined} children={undefined}>Get Started</Button>
          </Reveal>
        </div>
